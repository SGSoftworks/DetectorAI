  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const mockResult = {
        ...
        factors: [
          { name: 'Detección de deepfakes', value: 80, impact: 'negative' },
          { name: 'Consistencia temporal', value: 65, impact: 'positive' },
          { name: 'Calidad de audio', value: 70, impact: 'positive' },
          { name: 'Anomalías visuales', value: 75, impact: 'negative' }
        ],
        metadata: {
          timestamp: new Date(),
          processingTime: 5000,
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Analiza videos para detectar deepfakes y contenido generado por inteligencia artificial
          </p>
        </motion.div>
        ...
        >
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            >
              ...
              {isDragActive ? (
                <p className="text-primary-600 font-medium">Suelta el video aquí...</p>
              ) : (
                <div>
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <span>Detección de deepfakes</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                      <span>Consistencia temporal entre frames</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                      <span>Análisis de audio y sincronización</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                      <span>Anomalías visuales y artefactos</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                      <span>Patrones de compresión</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Este proceso puede tomar varios minutos dependiendo del tamaño del video.
                  </p>
                </div>
              </div>
            )}
