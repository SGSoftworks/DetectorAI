              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <ul className="space-y-1 text-blue-700">
                    <li>• Detección de deepfakes</li>
                    <li>• Consistencia temporal entre frames</li>
                    <li>• Análisis de audio y sincronización</li>
                    <li>• Anomalías visuales y artefactos</li>
                    <li>• Patrones de compresión</li>
                  </ul>
                </div>
              </div>
            </div>
